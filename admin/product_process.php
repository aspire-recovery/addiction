...
if (!empty($_POST['pdt_name']) &&  !empty($_POST['pdt_category']) && !empty($_POST['pdt_qty']) && !empty($_POST['pdt_price']) && !empty($_POST['pdt_description'])) {
    //Image Upload
    ...
    echo '<script>
        window.location.href = "product.php?error=true"
        </script>';
