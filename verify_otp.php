    ...
    <div class="container">
        <div class="top-map">
            <div class="row map-content-9">
                <div class="col-lg-8">
                    <h3 class="title-big" style="left: 20px;">Verify OTP</h3>
                    <form action="otp_verify_process.php" method="post" class="text-right"
                          style="width: 70%">
                        <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
                            <input type="number" name="otp" id="" placeholder="Enter Otp" required="">
                        </div>
                        <br>
