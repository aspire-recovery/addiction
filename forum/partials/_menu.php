    ...
    <div class="nav__categories js-dropdown" style="padding: 15px 0px;">
        <div class="nav__select">
            ...
            <nav class="dropdown dropdown--design-01" data-dropdown-list="categories">
                <ul class="dropdown__catalog row" id="cat_id">
                    <?php
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<li class="col-xs-6"><a href="forum.php?catid=' . $catid . '" id="' . $catid . '"class="category"><i class="bg-' . $color_array[$i] . '"></i>' . $catname . '</a>
                                </li>';
                    }
