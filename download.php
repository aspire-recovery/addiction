...
if (isset($_GET["id"])) {
    ...
    $html .= '<img src="assets/images/pdf.png" height="150" width="150"/><br />';

    $html .= '<h2 align="center"> Aspire Recovery </h2>
		<p align="center">115, Last Lane, NYC</p>
		<p align="center"><b>Contact No. - </b>9825183134</p></td></tr>
		';
    ...
    foreach ($appointment_data as $appointment_row) {
        ...
        foreach ($patient_data as $patient_row) {
            $html .= '<tr><th width="50%" align="right">Patient Name</th><td>' . $patient_row["u_name"] . ' </td></tr>
			<tr><th width="50%" align="right">Contact No.</th><td>' . $patient_row["u_contact"] . '</td></tr>
			<tr><th width="50%" align="right">Email</th><td>' . $patient_row["u_email"] . '</td></tr>';
        }
